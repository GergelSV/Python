...
class Table:
    ...
    def __str__(self):
        pass
    def __str__(self):
        return "This is table with lenght " + str(self.__my_lenght)

    def __lt__(self, other):
        if (type(other) == Table):
            if self.__my_lenght < other.__my_lenght:
                return True
        elif (type(other) == int):
            if self.__my_lenght < other:
                return True
    ...
    def __add__(self, other):
        if (type(other) == Table):
            return Table(self.my_height, self.__my_lenght + other.__my_lenght, self._my_width)
        elif (type(other) == int):
            return Table(self.my_height, self.__my_lenght + other, self._my_width)
    def __radd__(self, other):
        if (type(other) == Table):
            ...
            return Table(self.my_height, self.__my_lenght + other, self._my_width)
    def __int__(self):
        return self.my_height*self._my_width*self.__my_lenght
